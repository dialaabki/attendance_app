...
class ClockOut implements UseCase<void, UserEntity> {
  final AttendanceRepository attendanceRepository;
  final LocationRepository locationRepository;

  ClockOut(this.attendanceRepository, this.locationRepository);
  ...
  Future<Either<Failure, void>> call(UserEntity user) async { 
    ...
    return geofenceCheck.fold(
      ...
      (isWithin) {
        if (isWithin) {
          return attendanceRepository.clockOut(user.uid);
        } else {
